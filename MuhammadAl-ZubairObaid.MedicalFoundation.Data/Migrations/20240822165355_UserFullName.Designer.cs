...
namespace MuhammadAl_ZubairObaid.MedicalFoundation.Data.Migrations
{
    ...
    [Migration("20240822165355_UserFullName")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MuhammadAl_ZubairObaid.MedicalFoundation.Authorization.User", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MuhammadAl_ZubairObaid.MedicalFoundation.Domain.Primitives.Building", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<Guid>("ParentStreetID")
                        .HasColumnType("TEXT");

                    b.HasKey("ID");

                    b.HasIndex("ParentStreetID");

                    b.ToTable("Buildings");
                });

            modelBuilder.Entity("MuhammadAl_ZubairObaid.MedicalFoundation.Domain.Primitives.City", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MuhammadAl_ZubairObaid.MedicalFoundation.Domain.Primitives.Street", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MuhammadAl_ZubairObaid.MedicalFoundation.Domain.Primitives.Building", b =>
                {
                    b.HasOne("MuhammadAl_ZubairObaid.MedicalFoundation.Domain.Primitives.Street", "ParentStreet")
                        .WithMany()
                        .HasForeignKey("ParentStreetID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ParentStreet");
                });

            modelBuilder.Entity("MuhammadAl_ZubairObaid.MedicalFoundation.Domain.Primitives.Street", b =>
                {
                    b.HasOne("MuhammadAl_ZubairObaid.MedicalFoundation.Domain.Primitives.City", "ParentCity")
                        .WithMany()
